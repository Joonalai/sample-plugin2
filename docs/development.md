Development of SamplePlugin2 plugin
===========================
...
`git clone --recurse-submodules https://github.com/Joonalai/sample-plugin2.git`

The code for the plugin is in the [SamplePlugin2](../SamplePlugin2) folder. Make sure you have required tools, such as
Qt with Qt Editor and Qt Linquist installed by following this
[tutorial](https://www.qgistutorials.com/en/docs/3/building_a_python_plugin.html#get-the-tools).

For building the plugin use platform independent [build.py](../SamplePlugin2/build.py) script.
...
* they contain relative imports
    ...
    from SamplePlugin2.utils.exceptions import TestException # Bad
    ```
* they will be found by [build.py](../SamplePlugin2/build.py) script (`py_files` and `ui_files` values)
* you consider adding test files for the new functionality

## Deployment

Edit [build.py](../SamplePlugin2/build.py) to contain working values for *profile*, *lrelease* and *pyrcc*. If you are
...
* Add this badge ![](https://github.com/Joonalai/sample-plugin2/workflows/Translations/badge.svg) to
...
The translation files are in [i18n](../SamplePlugin2/resources/i18n) folder. Translatable content in python files is
